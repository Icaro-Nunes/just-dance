...
def main():
    ...
    # Open the video file
    video_path = "/home/josers/Code/whatever-projects/just-dance/pexels-artem-podrez-6003986 (2160p).mp4"  # Replace with the path to your video
    ...
    while cap.isOpened() and webcam.isOpened():
        ...
        if matching_video_pose is not None:
            similarity_score = compare_poses(latest_webcam_pose, matching_video_pose)
        ...
        cv2.imshow("Dance Comparison and Scoring", combined_frame)
